...
public class MobEffectInstance implements Comparable<MobEffectInstance> {
    ...
    public MobEffectInstance(MobEffect effect) {
        this(effect, 0, 0);
    }

    public MobEffectInstance(MobEffect effect, int var2) {
        this(effect, var2, 0);
    }

    public MobEffectInstance(MobEffect effect, int var2, int var3) {
        this(effect, var2, var3, false, true);
    }

    public MobEffectInstance(MobEffect effect, int var2, int var3, boolean var4, boolean var5) {
        this(effect, var2, var3, var4, var5, var5);
    }

    public MobEffectInstance(MobEffect effect, int var2, int var3, boolean var4, boolean var5, boolean var6) {
        this(effect, var2, var3, var4, var5, var6, null);
    }
